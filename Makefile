...
SUBDIRS= actisense-serial analyzer n2kd nmea0183 ip group-function candump2analyzer socketcan-writer can4linux-serial
...
install: rel/$(PLATFORM)/analyzer $(DESTDIR)$(BINDIR) $(DESTDIR)$(CONFDIR)
	...
	-killall -9 actisense-serial n2kd socketcan-writer can4linux-serial || echo 'No running processes killed'
